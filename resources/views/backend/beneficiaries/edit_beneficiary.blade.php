...
@section('title', 'Edit Beneficiary | River Edge')
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Edit Beneficiary</h4>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form method="post" action="{{route('admin.update.beneficiary', $data->id)}}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    @if($data->file && file_exists(public_path('uploads/beneficiaries/'.$data->file)))
                                        <p><a href="{{url('uploads/beneficiaries/'.$data->file)}}" target="_blank">Preview Current File</a></p>
                                    @endif
