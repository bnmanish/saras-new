...
@section('title', 'Add Director | River Edge')
@section('content')
<style type="text/css">
    .pcm{
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Add Director</h4>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form method="post" action="{{route('admin.store.director')}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="mb-3 row">
                             ...
                             <div class="mb-3 row">
                                 ...
                                 <div class="col-md-10">
                                     <textarea class="form-control texteditor" name="message" rows="3" placeholder="Message">{{old('message')}}</textarea>
