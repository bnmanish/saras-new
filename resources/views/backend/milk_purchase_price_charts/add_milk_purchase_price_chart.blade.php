...
@section('title', 'Add Milk Purchase Price Chart | River Edge')
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Add Milk Purchase Price Chart</h4>
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Add Milk Purchase Price Chart</li>
                        </ol>
                    </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form method="post" action="{{route('admin.store.milk_purchase_price_chart')}}" enctype="multipart/form-data">
                            @csrf
