...
@section('title', 'Edit Milk Purchase Price Chart | River Edge')
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Edit Milk Purchase Price Chart</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="{{route('admin.list.milk_purchase_price_charts')}}">Milk Purchase Price Charts</a></li>
                            <li class="breadcrumb-item active">Edit Milk Purchase Price Chart</li>
                        </ol>
                    </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form method="post" action="{{route('admin.update.milk_purchase_price_chart', $data->id)}}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" type="date" name="publish_date" value="{{$data->publish_date}}">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    @if($data->file && file_exists(public_path('uploads/milk_purchase_price_charts/'.$data->file)))
                                        <p><a href="{{url('uploads/milk_purchase_price_charts/'.$data->file)}}" target="_blank">Preview Current File</a></p>
                                    @endif
