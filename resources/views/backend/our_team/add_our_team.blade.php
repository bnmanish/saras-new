...
@section('title', 'Add Our Team | River Edge')
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Add Our Team</h4>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form method="post" action="{{route('admin.store.our_team')}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <textarea class="form-control texteditor" name="short_bio" rows="3" placeholder="Short Bio">{{old('short_bio')}}</textarea>
