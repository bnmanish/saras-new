...
@section('title', 'Edit Additional Page | River Edge')
@section('content')
<style type="text/css">
    .pcm{
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <form method="post" action="{{route('admin.edit.store.additional.page',$data->id)}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" type="text" name="slug" placeholder="slug *" value="{{$data->slug}}">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control dropify" type="file" name="file" data-default-file="{{url('uploads/page/additional/'.$data->image)}}">
