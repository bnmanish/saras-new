...
@section('title', 'Subscriber | River Edge')
@section('content')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Subscriber List</h4>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mb-4 border-bottom">
                            ...
                            {{--
                            <div class="col-6">
                                <h4 class="card-title text-end"><a href="#" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i></a></h4>
                            </div>
                            --}}
                        </div>
