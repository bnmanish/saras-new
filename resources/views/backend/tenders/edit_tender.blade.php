...
@section('title', 'Edit Tender | River Edge')
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form method="post" action="{{route('admin.update.tender', $data->id)}}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    @if($data->file && file_exists(public_path('uploads/tenders/'.$data->file)))
                                        <p><a href="{{url('uploads/tenders/'.$data->file)}}" target="_blank">Preview Current File</a></p>
                                    @endif
