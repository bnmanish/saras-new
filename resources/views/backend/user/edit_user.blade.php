                    ...
                    <div class="card-body">
                        <form method="post" action="{{route('admin.edit.store.user',$data->id)}}">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control @if($errors->first('mobile')) border-danger @endif" type="text" name="mobile" value="{{$data->mobile}}">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-check form-switch" type="checkbox" id="emailstatus" switch="bool" name="emailverified" @if($data->email_verified == '1') checked @endif>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-check form-switch" type="checkbox" id="mobilestatus" switch="bool" name="mobileverified" @if($data->mobile_verified == '1') checked @endif>
